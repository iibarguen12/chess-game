...
public class Knight extends Piece{
    ...
    private static boolean isColumnsExclusion(final int currentPosition, final int candidateOffset){
        return isFirstColumnExclusion(currentPosition, candidateOffset) || isSecondColumnExclusion(currentPosition, candidateOffset) ||
                isSevenColumnExclusion(currentPosition, candidateOffset) || isEightColumnExclusion(currentPosition, candidateOffset);
    }
